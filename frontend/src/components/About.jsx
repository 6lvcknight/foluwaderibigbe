    ...
    return (
        <div className=''>
            <div className='flex flex-col items-center'>
                {isLoggedIn ? (
                    <a href='/dashboard' className="mb-12 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl text-white">
                        About Me
                    </a>
                ) : (
                ...
                <p className="pb-20 text-neutral-400">
